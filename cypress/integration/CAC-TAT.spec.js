...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        ...
        cy.get('#lastName')
            ...
            .should('have.value', "")
        cy.get('#email')
            .type('pablorudah@gmail.com')
            .should('have.value', 'pablorudah@gmail.com')
            .clear()
            .should('have.value', "")
        cy.get('#phone')
            .type('15992459438')
            .should('have.value', '15992459438')
            .clear()
            .should('have.value', "")
    })
    ...
    it('marca cada tipo de atendimento', function() {
        cy.get('input[type="radio"]')
            /* verificação intermediária pra contar quantos itens foram marcados */
            .should('have.length', 3)
            /* encadeia o .each para passar por cada elemento, recebendo uma função como argumento */            
            .each(function($radio) {
                cy.wrap($radio).check()
